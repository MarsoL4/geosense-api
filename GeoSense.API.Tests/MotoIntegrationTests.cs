...
{
    public class MotoIntegrationTests : IClassFixture<CustomWebApplicationFactory<GeoSense.API.Program>>
    {
        private readonly HttpClient _client;

        public MotoIntegrationTests(CustomWebApplicationFactory<GeoSense.API.Program> factory)
        {
